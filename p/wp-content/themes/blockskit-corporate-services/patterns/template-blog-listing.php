 ...
 * Slug: blockskit-corporate-services/template-blog-listing
 * Categories: template
 * Inserter: false
 */
...
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"blockskit-corporate-services"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->