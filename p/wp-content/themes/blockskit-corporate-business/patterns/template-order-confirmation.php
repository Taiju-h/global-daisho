 ...
 * Slug: blockskit-corporate-business/template-order-confirmation
 * Categories: template
 * Inserter: false
 */
...
<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Order Confirmation', 'blockskit-corporate-business' ); ?></h1>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Order details', 'blockskit-corporate-business' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Downloads', 'blockskit-corporate-business' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Shipping address', 'blockskit-corporate-business' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Billing address', 'blockskit-corporate-business' ); ?></h3>
<!-- /wp:heading -->
