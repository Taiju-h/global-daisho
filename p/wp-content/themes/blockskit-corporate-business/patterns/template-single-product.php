 ...
 * Slug: blockskit-corporate-business/template-single-product
 * Categories: template
 * Inserter: false
 */
...
<div class="wp-block-cover alignfull" style="margin-bottom:var(--wp--preset--spacing--large);padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);min-height:480px"><span aria-hidden="true" class="wp-block-cover__background has-foreground-background-color has-background-dim-80 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-79" alt="" src="<?php echo esc_url($blockskit_corporate_business_images[0]); ?>" style="object-position:50% 0%" data-object-fit="cover" data-object-position="50% 0%"/><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","level":1} -->
<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Single Product', 'blockskit-corporate-business' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related products', 'blockskit-corporate-business' ); ?></h2>
<!-- /wp:heading -->
